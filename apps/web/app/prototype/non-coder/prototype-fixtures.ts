...
function blueprintFor(brief: PrototypeBrief, preset: DirectionPreset): LandingPageBlueprintV2 {
  return {
    ...
    navbar: {
      ...
      links: [
        { text: 'Lợi ích', href: '#features' },
        { text: 'Câu chuyện', href: '#stories' },
        { text: 'Câu hỏi', href: '#questions' },
      ],
      cta: { text: brief.cta, href: '#contact' },
    },
    hero: {
      variant: preset.hero,
      badge: brief.style,
      ...
      primaryCta: { text: brief.cta, href: '#contact' },
      secondaryCta: { text: 'Xem cách hoạt động', href: '#features' },
    ...
    sections: [
      ...
      },
      {
        ...
        primaryCta: { text: brief.cta, href: '#contact' },
        secondaryCta: { text: 'Xem lại lợi ích', href: '#features' },
      },
      {
        type: 'footer',
        ...
        columns: preset.footer === 'columns' ? [
          { heading: 'Sản phẩm', links: [{ text: 'Lợi ích', href: '#features' }, { text: 'Câu hỏi', href: '#questions' }] },
